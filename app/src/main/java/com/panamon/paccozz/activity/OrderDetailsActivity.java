...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    String name,price,orderID,orderCode,pushTime,status,discountStr,packageModeStr,totCostStr,itemnamestr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName1.setText(itemnamestr);
        itemprice2.setText("");
        totalpayableAmount.setText("₹ "+totCostStr);
       // vat.setText("");
